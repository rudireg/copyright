...
<!-- Меню -->
<div class="top_menu" style="min-width:960px;">
<div><?=ShowOrderMenu();?></div>
</div>
<!-- / Меню -->

<div class="container_16" style="min-height:600px;min-width:960px;">
    <div class="grid_5">
	<br />
	<div class="boxer">
	...
	<div class="boxer">
	            <center>
			         <button id="BtnSeeNewArticle" class="button" name="BtnSeeNewArticle" onclick="ShowNewArticle();" tabindex="5" type="submit">Взять задание</button>
			    </center>
	</div>	
	<hr>
	<div class="boxer">
